...
// Translation related
var text_domain             = 'bs4wp'; // Your textdomain here.
var destFile                = 'bs4wp.pot'; // Name of the transalation file.
var packageName             = 'bs4wp'; // Package name.
...
var scriptSRC             = [
                              ...
                              // './assets/js/vendor/bootstrap/class-helpers.js', // Pure JS class toggling
...
// Watch file paths
var styleWatchFiles         = './assets/scss/**/*.scss'; // Path to all *.scss files inside scss folder and subfolders
var styleAdminWatchFiles    = ['./assets/scss/base/*.scss', './assets/scss/login-style.scss'] ; // Path to admin SCSS file
var scriptJSWatchFiles      = [
                                './assets/js/vendor/**/*.js',
